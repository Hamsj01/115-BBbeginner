...
VALUEs 
('Sezen Aksu','sezenasksu@hotmail.com', 'Proje Teklifi', 'Proje teklifimizi ğaylaşmak isteriz'),
('Ali Cabbar', 'ali@hotmail.com', 'Gırnata', 'Düğünlerde gırnata'),
('Alex Desoza','dsdwd@hotmail.com','HOPPA','YALNIZICIMDSAQ')
GO

insert into Contacts(Name,Email,Subject, Message,ContactId)
VALUES 
('Kemal Kodyazar', 'İnfo@.com', 'Ynt:Klarnet tekflifi','ynt:Düğün yapmıyoruz', 3)
